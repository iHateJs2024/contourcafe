...
if (isset($_POST['signup-button'])) {
  ...
  if ($result->num_rows > 0) {
    ...
    $insertQuery = "INSERT INTO pelanggan (namapelanggan, password_pelanggan, nohp, email_pelanggan, account_activation_hash)
                          VALUES ('$username', '$password', '$nohp', '$email', '$activation_token_hash')";
