...
try {
  ...
  $session = \Stripe\Checkout\Session::create([
    ...
    'mode' => 'payment',
    'success_url' => 'http://contourcafe.great-site.net/admin/successAdmin.php?session_id={CHECKOUT_SESSION_ID}',
    'cancel_url' => 'http://contourcafe.great-site.net/admin/admin-menu-checkout.php',
  ]);
