...
session_start();
// Database connection details for orders and customer_details
define('DB_ORDERS', ['host' => 'localhost', 'user' => 'root', 'pass' => '', 'name' => 'tempahan']);
...
if (isset($_GET['idpelanggan'])) {
  ...
  $connOrders = connectDb(DB_ORDERS);
...
if (isset($_GET['idpelanggan'])) {
  ...
  if ($stmt) {
    ...
    if ($result->num_rows > 0) {
      ...
      $namapelangan = $row['namapelanggan'];
      $nohp = $row['nohp'];
