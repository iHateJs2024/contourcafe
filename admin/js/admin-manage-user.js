...
document.querySelectorAll(".edit-button").forEach((editButton) => {
  ...
  editButton.addEventListener("click", () => {
    ...
    checkValidityAlamatEditUserDialog(editButtonId);
    ...
    resetInputAlamatEditUserDialog(editButtonId);
  });
});
...
function checkValidityAlamatEditUserDialog(id) {
  let inputElement = document.getElementById(`alamat-${id}`);
  let label = document.getElementById(`label-alamat-${id}`);
...
function resetInputEmailEditUserDialog(id) {
  ...
  label.classList.remove("invalid");
  inputElement.classList.remove("invalid");
  errorTextEmail.innerHTML = "e.g. kongjiale12gmail.com";
}
...
function resetInputAlamatEditUserDialog(id) {
  let label = document.getElementById(`label-alamat-${id}`);
